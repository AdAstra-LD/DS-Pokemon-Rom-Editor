            ...
            using (BinaryReader reader = new BinaryReader(data)) {
                ...
                for (int i = 0; i < 4; i++) {
                    try {
                        ...
                        radarPokemon[i] = 0x00;
                        fieldsWithErrors.Add("PokÈRadar" + ' ' + '[' + i + ']' + msgFixed);
                    }
                }
            ...
            using (BinaryReader reader = new BinaryReader(data)) {
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    try {
                        ...
                        fieldsWithErrors.Add("Surf Encounters" + ' ' + '[' + i + ']' + " PokÈmon" + msgFixed);
                    }
                }
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    try {
                        ...
                        fieldsWithErrors.Add("Rock Smash Encounters" + ' ' + '[' + i + ']' + " PokÈmon" + msgFixed);
                    }
                }
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    try {
                        ...
                        fieldsWithErrors.Add("Old Rod Encounters" + ' ' + '[' + i + ']' + " PokÈmon" + msgFixed);
                    }
                }
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    try {
                        ...
                        fieldsWithErrors.Add("Good Rod Encounters" + ' ' + '[' + i + ']' + " PokÈmon" + msgFixed);
                    }
                }
                ...
                for (int i = 0; i < 5; i++) {
                    ...
                    try {
                        ...
                        fieldsWithErrors.Add("Super Rod Encounters" + ' ' + '[' + i + ']' + " PokÈmon" + msgFixed);
                    }
                }
