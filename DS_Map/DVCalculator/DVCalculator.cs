    ...
    internal static class DVCalculator
    {
        ...
        public static readonly List<string> Natures = new List<string>
            ...
            public static class TrainerClassGender
            {
                ...
                // This should be at 0xF0714 in the ARM9 (at least in USA)
                ...
                // This should be at 0xFFB90 in the ARM9 (at least in HG USA)
                // No idea where these would be in other languages
