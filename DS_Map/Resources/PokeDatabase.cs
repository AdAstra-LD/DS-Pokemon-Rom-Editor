    ...
    public static class PokeDatabase {
        ...
        public static class ScriptEditor {
            ...
            public static Dictionary<ushort, string> DPPtScrCmdNames = new Dictionary<ushort, string>() {
                ...
                [0x006A] = "CheckOWPosition",

                [0x006C] = "KeepOW",
                [0x006D] = "SetOWMove",
                [0x006E] = "SetFollowingOW",
                [0x006F] = "GiveMoney",
                [0x0070] = "TakeMoney",
                [0x0071] = "CompareMoney",
                [0x0072] = "ShowMoney",
                ...
                [0x0178] = "BagScreen",
                [0x0179] = "BagSelectionScreen",
                [0x017A] = "CheckPocketItems",
                [0x017B] = "TextBerry",
                [0x017C] = "TextNature",
                [0x017D] = "CheckBerryGrowth",
                [0x017E] = "CheckBerrySpecies",
                [0x017F] = "CheckBerryMulch",
                [0x0180] = "CheckBerryDryness",
                [0x0181] = "CheckBerryAmount",
                [0x0182] = "SetBerryMulch",
                [0x0183] = "SetBerrySpecies",
                [0x0184] = "WateringAnimation",
                [0x0185] = "TakeBerries",
                [0x0186] = "SetOWPosition",
                [0x0187] = "SetOWFullPosition",
                [0x0188] = "SetOWMovement",
                [0x0189] = "SetOWDirection",
                [0x018A] = "SetDoorPassable",
                [0x018B] = "SetDoorLocked",

                [0x0198] = "CheckPartyPokeID",
                [0x0199] = "CheckIfPokemonTraded",
                ...
                [0x0208] = "ShowPokePicture",
                [0x0209] = "HidePokePicture",
            ...
            public static Dictionary<ushort, string> HGSSScrCmdNames = new Dictionary<ushort, string>() {
                ...
                [0x00A3] = "EndGame",
                [0x00A6] = "WFC",
                [0x00A7] = "ChooseStarterScreen",

                [0x00AD] = "ChoosePokemonName",
                [0x00AE] = "FadeScreen",
                [0x00AF] = "WaitFadeScreen",
                [0x00B0] = "Warp",

                [0x00B1] = "RockClimbAnim",
                [0x00B2] = "SurfAnim",
                [0x00B3] = "WaterfallAnim",
                [0x00B4] = "FlyAnim",
                [0x00B5] = "FlashAnim",
                [0x00B6] = "WhirlpoolAnim",
                [0x00B7] = "CutAnim",
                [0x00B8] = "CheckBike",
                [0x00B9] = "RideBike",
                [0x00BA] = "CyclingRoad",
                ...
                [0x00F2] = "ElevatorBox",
                [0x00F3] = "JohtoDexSeen",
                [0x00F4] = "JohtoDexObtained",
                [0x00F5] = "NationalDexSeen",
                [0x00F6] = "NationalDexObtained",
                ...
                [0x0152] = "SetOWPosition",
                [0x0153] = "SetOWFullPosition",
                [0x0154] = "SetOWMovement",
                [0x0155] = "SetOWDirection",
                [0x0156] = "SetDoorPassable",
                [0x0157] = "SetDoorLocked",

                [0x0162] = "CheckPartyPokeID",
                ...
                [0x01A7] = "CheckJohtoDex",
                [0x01A8] = "CheckNationalDex",

                [0x01AD] = "GetFossilCount",

                [0x01B0] = "CheckPokeNameFromFossil",
                [0x01B1] = "CheckFossil",
                [0x01B2] = "CheckPokeUnderLevel",
                [0x01B3] = "SurvivePoison",

                [0x01BD] = "CheckPreviousHeader",
                ...
                [0x0204] = "TextAccesory",
                [0x0205] = "CheckPokeInParty",
                [0x0206] = "SetDeoxysForm",
                [0x0207] = "CheckBurmyForm",
                [0x020A] = "GetHour",
                [0x020B] = "ShakeOW",
                [0x020C] = "BlinkOW",
                [0x020D] = "CheckRegisInParty",
                [0x020F] = "MessageUnown",
                ...
                [0x0257] = "FollowingPokePCAnim",
                [0x0258] = "DisableFollowingPoke",
                ...
                [0x0260] = "ActivateFollowingPoke",
                [0x0261] = "MecScript",
                [0x0267] = "TakePhoto",
                [0x026A] = "CheckAlbumPhoto",
                [0x026E] = "CheckOWDirection",
                [0x02BC] = "CheckWildBattle2",
                [0x02BD] = "WildBattle2",

                [0x02C7] = "TalkToFollowingPoke",
