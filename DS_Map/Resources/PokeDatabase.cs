    ...
    public static class PokeDatabase {
        ...
        public static class ScriptEditor {
            ...
            public static Dictionary<ushort, string> DPPtScrCmdNames = new Dictionary<ushort, string>() {
                ...
                [0x0031] = "WaitButton",
                [0x0034] = "CloseMessage",
                [0x0035] = "FreezeMessageBox",
                [0x0036] = "CallMessageBox",
                [0x0037] = "ColorMessageBox",
                [0x0038] = "TypeMessageBox",
                [0x0039] = "NoMapMessageBox",
                [0x003A] = "CallMessageBoxText",
                [0x003C] = "Menu",
                [0x003E] = "YesNoBox",
                [0x003F] = "WaitFor",
                [0x0040] = "Multi",
                ...
                [0x004D] = "WaitCry",
                [0x004E] = "PlaySound",
                [0x004F] = "FadeDefaultMusic",
                [0x0050] = "PlayMusic",
                [0x0051] = "StopMusic",
                [0x0052] = "RestartMusic",
                [0x0054] = "SwitchMusic",
                [0x005A] = "SwitchMusic2",
                [0x005E] = "ApplyMovement",
                [0x005F] = "WaitMovement",
                [0x0060] = "LockAll",
                [0x0061] = "ReleaseAll",
                [0x0062] = "Lock",
                ...
                [0x0066] = "LockCam",
                [0x0068] = "FacePlayer",
                [0x0069] = "CheckSpritePosition",
                [0x006B] = "CheckPersonPosition",
                [0x006C] = "ContinueFollow",
                [0x006D] = "FollowHero",
                [0x006E] = "StopFollowHero",
                [0x006F] = "GiveMoney",
                [0x0070] = "TakeMoney",
                [0x0071] = "CheckMoney",
                [0x0072] = "ShowMoney",
                ...
                [0x007B] = "GiveItem",
                [0x007C] = "TakeItem",
                [0x007D] = "GiveItemPrecheck",
                [0x007E] = "CheckPlayerHasItem",
                [0x007F] = "CheckItemIsMachine",
                [0x0080] = "GetItemPocket",
                [0x0085] = "CheckUndergroundPcStatus",
                [0x0093] = "CheckPokémonParty",
                [0x0094] = "StorePokémonParty",
                [0x0095] = "SetPokémonPartyStored",
                [0x0096] = "GivePokémon",
                [0x0097] = "GiveEgg",
                [0x0099] = "CheckMove",
                [0x009A] = "CheckPlaceStored",
                [0x009C] = "SetWeather",
                [0x009D] = "InitWeather",
                [0x009E] = "UpdateWeather",
                [0x00A1] = "CallEnd",
                [0x00A3] = "WFC",
                [0x00A5] = "Interview",
                [0x00A6] = "DressPokémon",
                ...
                [0x00CD] = "SetVariableHero",
                [0x00CE] = "SetVariableRival",
                [0x00CF] = "SetVariableAlter",
                [0x00D0] = "SetVariablePokémon",
                [0x00D1] = "SetVariableItem",
                [0x00D3] = "SetVariableAttackItem",
                [0x00D4] = "SetVariableAttack",
                [0x00D5] = "SetVariableNumber",
                [0x00D6] = "SetVariableNickname",
                [0x00D7] = "SetVariableObject",
                [0x00D8] = "SetVariableTrainer",
                [0x00DA] = "SetVarPokémonStored",
                [0x00DB] = "SetVarHeroStored",
                [0x00DC] = "SetVarRivalStored",
                [0x00DD] = "SetVarAlterStored",
                [0x00DE] = "StoreStarter",
                [0x00E5] = "TrainerBattle",
                [0x00E6] = "EndTrainerBattle",
                [0x00EA] = "ActLeagueBattlers",
                [0x00EB] = "LostGoPokecenter",
                [0x00EC] = "CheckLost",
                [0x00F2] = "ChooseFriend",
                ...
                [0x011B] = "WarpMapElevator",
                [0x011C] = "CheckFloor",
                [0x0120] = "SetPositionAfterShip",
                [0x0124] = "WildBattle",
                [0x0125] = "StarterBattle",
                [0x0126] = "ExplanationBattle",
                [0x0127] = "HoneyTreeBattle",
                [0x0129] = "RandomBattle",
                [0x012B] = "WriteAutograph",
                [0x012E] = "CheckDress",
                [0x0131] = "GivePokétch",
                [0x0133] = "ActivatePokétchApp",
                [0x0134] = "StorePokétchApp",
                [0x0143] = "ExpectDecisionOther",
                [0x0147] = "PokéMart",
                [0x0148] = "PokéMart1",
                [0x0149] = "PokéMart2",
                [0x014A] = "PokéMart3",
                [0x014B] = "DefeatGoToPokéCenter",
                [0x014D] = "CheckGender",
                [0x014E] = "HealPokémon",
                [0x0153] = "UnionRoom",
                [0x0158] = "ActivatePokédex",
                [0x015A] = "GiveRunningShoes",
                [0x015B] = "CheckBadge",
                [0x015C] = "EnableBadge",
                [0x015D] = "DisableBadge",
                ...
                [0x01BD] = "CheckPosition",
                [0x01C0] = "CheckPokémonParty2",
                [0x01C1] = "CopyPokémonHeight",
                [0x01C2] = "SetVariablePokémonHeight",
                ...
                [0x0232] = "TextRibbon",
                [0x0239] = "DecideRules",
                [0x023B] = "AnimationPCHeal",
                [0x023C] = "AnimationElevator",
                [0x023D] = "AnimationShip",
                [0x0243] = "PhraseBox1W",
                [0x0244] = "PhraseBox2W",
                ...
                [0x0257] = "SprtSave",
                [0x0258] = "RetSprtSave",
                [0x0259] = "ElevLgAnimation",
                [0x0261] = "CheckAccessories",
                [0x0267] = "SlotMachine",
            ...
            public static Dictionary<ushort, string> HGSSScrCmdNames = new Dictionary<ushort, string>() {
                ...
                [0x007F] = "GiveItem",
                [0x0080] = "CheckItem",
                [0x0084] = "DoubleMessage",
                [0x0089] = "GiveStoredPokemon",
                [0x0092] = "RecordPokegearNumber",
                [0x0096] = "CallEnd",
                [0x0098] = "Wifi",
                [0x009A] = "OpenPokemonDress",
                [0x009D] = "OpenPokegearMap",
                [0x00A1] = "CallEnd2",
                [0x00A3] = "EndGame",
                [0x00A6] = "WFC",
                [0x00AD] = "GivePokemonNickname",
                [0x00AE] = "SetFadeScreen",
                [0x00AF] = "WaitFadeScreen",
                [0x00B0] = "Warp",
                [0x00B1] = "HallFameData",
                [0x00B3] = "WFC1",
                [0x00BA] = "CyclingRoadMode",
                [0x00BE] = "SetVariableHero",
                [0x00BF] = "SetVariableRival",
                [0x00C0] = "SetVariableAlter",
                [0x00C1] = "SetVariablePokemon",
                [0x00C2] = "SetVariableItem",
                [0x00C4] = "SetVariableAttackItem",
                [0x00C5] = "SetVariableAttack",
                [0x00C6] = "SetVariableNumber",
                [0x00C7] = "SetVariablePokemonNickname",
                [0x00C8] = "SetVariableObject",
                [0x00CA] = "SetVariablePokemonStored",
                [0x00CD] = "CheckStarter",
                [0x00D5] = "TrainerBattle",
                [0x00DB] = "LostGoPokecenter",
                [0x00DC] = "CheckLost",
                [0x00DE] = "StoreStarter",
                ...
                [0x0176] = "OverworldUnvanish",
                [0x0177] = "OverworldVanish",
                [0x0178] = "OpenMail",
                [0x0179] = "CheckMail",
                ...
                [0x02BC] = "CheckWildBattle2",
                [0x02BD] = "WildBattle2",
                [0x02EA] = "OpenLowScreen",
                [0x02EB] = "CloseLowScreen",
                [0x02EC] = "OpenLowYesNoBox",
                [0x02ED] = "Multi4",
                [0x02EE] = "Multi5",
                [0x02EF] = "TextScriptMulti4",
                [0x02F0] = "CloseMulti4",
                [0x0319] = "TakeMomMoney",
                [0x031A] = "GiveMomMoney",
